...
// Marker 필드: 0=ability_id, 1=prompt_tag, 2=tr_dispatch_fn, 3=handler_dispatch
...
let handler = adt.struct_get(marker, 3)  // handler_dispatch 필드 (인덱스 3)
...
fn state_get(ev: Evidence) -> s {
    ...
    let handler = adt.struct_get(marker, 3)           // handler_dispatch (인덱스 3)
