...
//!
//! Provides `arena_dialect!` proc macro for defining arena-based
...
/// ```ignore
/// arena_dialect! {
///     #[crate = crate]  // optional: inside trunk-ir
///     mod func {
...
#[proc_macro]
pub fn arena_dialect(input: ProcTokenStream) -> ProcTokenStream {
    match arena_dialect_impl(input.into()) {
...
fn arena_dialect_impl(input: proc_macro2::TokenStream) -> Result<proc_macro2::TokenStream, String> {
    let (crate_path, module) = parse::parse_input(input)?;
