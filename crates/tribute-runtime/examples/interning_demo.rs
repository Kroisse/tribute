...
fn main() {
    ...
    unsafe {
        ...
        let true1 = tribute_new_boolean(runtime, true);
        let true2 = tribute_new_boolean(runtime, true);
        let false1 = tribute_new_boolean(runtime, false);
        let false2 = tribute_new_boolean(runtime, false);
        ...
        let nil1 = tribute_new_nil(runtime);
        let nil2 = tribute_new_nil(runtime);
        ...
        tribute_clear_all(runtime);
        
        println!("  Is true still valid? {}", tribute_is_valid(runtime, true1));
        println!("  Is false still valid? {}", tribute_is_valid(runtime, false1));
        println!("  Is nil still valid? {}", tribute_is_valid(runtime, nil1));
        println!("  Is num1 still valid? {}", tribute_is_valid(runtime, num1));
        println!("  => Only interned values survive clear_all");
        
        println!("\n7. String interning demo:");
        let empty_str1 = tribute_new_string(runtime, std::ptr::null(), 0);
        let empty_str2 = tribute_new_string_from_str(runtime, "");
        ...
        let hello1 = tribute_new_string_from_str(runtime, "hello");
        let hello2 = tribute_new_string_from_str(runtime, "hello");
        ...
        println!("  hello1 length: {}", tribute_get_string_length(runtime, hello1));
