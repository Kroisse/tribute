...
//!
//! - `ModuleTypeEnv`: Module-level type information (function/constructor/type definitions).
//!   This is populated during collect_declarations and is read-only afterward.
//!
//! - `TypeContext`: Legacy context that combines module-level and function-level state.
//!   Being replaced by the ModuleTypeEnv + FunctionInferenceContext split.
...
// =========================================================================
// TypeContext: Legacy combined context (being phased out)
// =========================================================================
