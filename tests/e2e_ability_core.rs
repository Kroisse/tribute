//! End-to-end tests for Ability System (Core) — Frontend tests.
//!
//! These tests verify the target code from issue #100 passes the full compilation
//! pipeline (parsing, name resolution, type checking).
//!
//! ## Test Strategy
//!
...
// =============================================================================
// Closure / call_indirect with Effects Tests (compile-only)
// =============================================================================
