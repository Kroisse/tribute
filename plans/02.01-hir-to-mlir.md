...
**Status**: ❌ **DEPRECATED** - Superseded by new compiler architecture
**Superseded By**: [../new-plans/tribute-design.md](../new-plans/tribute-design.md), [../new-plans/tribute-implementation.md](../new-plans/tribute-implementation.md)
**Deprecation Date**: 2024-12-15
**Reason**: MLIR approach abandoned; new design uses Cranelift + WasmGC dual-target architecture with custom multi-level IR

> ⚠️ **This plan has been deprecated.**
> The new compiler architecture in `new-plans/` uses:
> - Custom multi-level IR (Surface → Typed → Core → Effect dialects)
> - Cranelift backend for native compilation
> - WasmGC backend for web/WASI targets
> - Effect handler lowering with delimited continuations

---

## Original Plan (DEPRECATED)

**Original Status**: 📋 **PLANNED** - Not yet started
